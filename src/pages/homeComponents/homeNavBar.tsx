...
const HomeNavBar:React.FC<NavBarProps> = ({selectedPage,setSelectedPage}) => {
  ...
  return (
    <div className="relative z-10 flex min-h-20 w-screen items-center justify-center gap-40 font-semibold text-black">
      ...
      <div className="item-center absolute right-5 right-32 z-10 flex">
        {' '}
        {isAuthenticated ? <LogoutButton /> : <LoginButton />}
      </div>

      <div onClick = {()=>setSelectedPage('Home')} className="cursor-pointer font-changa hover:opacity-75 absolute left-32 flex w-40">
      ...
      <div className=" flex items-center justify-center gap-10 text-md">
