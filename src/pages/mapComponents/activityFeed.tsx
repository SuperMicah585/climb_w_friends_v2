...
return(
   <div className = 'flex flex-col items-center justify-center absolute z-10 border border-slate-500 right-1 top-1 rounded bg-zinc-900 bg-opacity-90 text-white'> 
