...
const AddFriendModal:React.FC<EditFriendModalProps> = ({editMapObject,closeModalCallBack,mapId}) =>{
...
return(
    ...
    <div className="flex h-full w-full flex-col gap-5 overflow-y-scroll p-1 mt-10">
