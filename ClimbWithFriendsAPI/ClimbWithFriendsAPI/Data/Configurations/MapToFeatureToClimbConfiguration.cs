    ...
    public class MapToFeatureToClimbConfiguration : IEntityTypeConfiguration<MapToFeatureToClimb>
    {
        public void Configure(EntityTypeBuilder<MapToFeatureToClimb> builder)
        {
            ...
            builder.HasData(
                ...
                new MapToFeatureToClimb { Id = 2, MapId = 101, ClimbId = 5, FeatureId = 2, AssociatedAt = "2024-12-01T10:00:00Z" },
                new MapToFeatureToClimb { Id = 3, MapId = 101, ClimbId = 4, FeatureId = 3, AssociatedAt = "2024-12-01T10:00:00Z" },
                new MapToFeatureToClimb { Id = 4, MapId = 101, ClimbId = 3, FeatureId = 4, AssociatedAt = "2024-12-01T10:00:00Z" },
                new MapToFeatureToClimb { Id = 5, MapId = 101, ClimbId = 2, FeatureId = 5, AssociatedAt = "2024-12-01T10:00:00Z" },
                new MapToFeatureToClimb { Id = 6, MapId = 101, ClimbId = 1, FeatureId = 6, AssociatedAt = "2024-12-01T10:00:00Z" }
            );
        }
    }
}