...
namespace ClimbWithFriendsAPI.Migrations
{
    ...
    [Migration("20241119180102_climbtyperemovelist")]
    partial class climbtyperemovelist
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClimbWithFriendsAPI.Data.Climb", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = "2024-11-19T18:01:02.0026978Z",
                            Description = "One of the most iconic climbs in the world.",
                            Location = "Yosemite National Park",
                            Pitches = 30,
                            Rating = "5.12d",
                            UpdatedAt = "2024-11-19T18:01:02.0026999Z",
                        ...
                        new
                        {
                            ...
                            ClimbType = "Trad,Big Wall",
                            Coordinates = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-119.638 37.733)"),
                            CreatedAt = "2024-11-19T18:01:02.0027009Z",
                            Description = "A legendary climb with a rich history.",
                            Location = "Yosemite National Park",
                            Pitches = 31,
                            Rating = "5.14a",
                            UpdatedAt = "2024-11-19T18:01:02.0027010Z",
                        ...
                        new
                        {
                            ...
                            CreatedAt = "2024-11-19T18:01:02.0027016Z",
                            Description = "A stunning climb up a sandstone wall.",
                            Location = "Zion National Park",
                            Pitches = 9,
                            Rating = "5.12d",
                            UpdatedAt = "2024-11-19T18:01:02.0027017Z",
